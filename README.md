...
- Voices of Nashville is a public interactive web app that tells the history of Nashville through personal stories. Using google maps users can pin a story to a location within davidson county. The story can include an image, video, or audio, with a written out description of the story.
